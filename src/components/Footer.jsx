      ...
      <main>
        <div className="view-container mt-10 grid md:grid-cols-2 grid-cols-1 mb-[150px] gap-4 overflow:hidden ">
          <div className="flex flex-col font-medium w-full  text-xl text-white  gap-1 mb-4">
            <div className="music border border-zinc-500 w-full py-4 pl-4 pr-8 bg-zinc-950 rounded-full  flex gap-4 items-center  svelte-gfa3ns">
              <div>
              ...
              <div className="track-list ml-3 w-full">
                <div className="font-normal mb-1">On repeat</div>
                <div className="song w-full">
                  <a className="mr-4 md:text-lg text-lg " href="https://open.spotify.com/track/1rTVcF2lyMET3NLQJlHWkr">Pocket Full Of Rain ~The Paper Kites</a>
                  <p></p>
                </div>
              </div>
            </div>
