...
function CraftsButtonPage() {
  useEffect(() => {
    ...
    script.async = true;
    script.onload = () => setTweetLoading(false); // Hide spinner when tweet loads
  ...
  return (
    ...
    <section className="py-4 md:py-8 px-4 md:px-6 max-w-[600px] mx-auto ">
      <Link href="/crafts">
        <span className="text-sm mb-4 text-neutral-500 dark:text-neutral-400">Back to Crafts</span>
      </Link>
      <h1 className="text-xl mb-1 font-semibold text-neutral-700 dark:text-neutral-200">
        Animated Button component
      </h1>
      <p className="text-neutral-700 dark:text-neutral-300">
        CTA button with animation using pure js.
      </p>
      ...
      <div className="text-base mt-4 text-neutral-700 dark:text-neutral-300">
        ...
        <span className="font-medium text-lime-500 dark:text-lime-400">
        ...
        <div>
          <h3 className="font-semibold mt-2 mb-1 text-neutral-700 dark:text-neutral-200">
            Hover Animation
          </h3>
        ...
        <div>
          ...
          <p className="font-medium mt-4 text-neutral-700 dark:text-neutral-300">
